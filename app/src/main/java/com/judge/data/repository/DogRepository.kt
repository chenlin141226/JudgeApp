    ...
    fun getDogs() = Observable.fromCallable<List<Dog>> {
        ...
        listOf(
            ...
            Dog(
                ...
                "Maya",
                "German Shepherd Mix",
                "https://www.sfspca.org/sites/default/files/styles/480_width/public/images/animals/40379134-a547eac3.jpg?itok=suIPHv15",
            ...
            Dog(
                ...
                "https://www.sfspca.org/sites/default/files/styles/480_width/public/images/animals/40706214-5b51f8de.jpg?itok=Hh3s2y0u",
            ...
            Dog(
                ...
                "Wonder",
                "Shepherd Mix",
                "https://www.sfspca.org/sites/default/files/styles/480_width/public/images/animals/39822990-628b4657.jpg?itok=VX5kBJJC",
            ...
            Dog(
                ...
                "https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/44371030/1/?bust=1554250257&width=1080",
                "On Tue Apr 02 08:10:18 PDT 2019 Happy was available. For current animal profile, images and videos please visit http://petportal.oaklandanimalservices.org/myapp/publicAnimalProfile/show/35137 All animals are listed as spayed/neutered, even if they currently are not, since they will be fixed before leaving the shelter. To adopt: Other canines in the home must meet the new dog prior to adoption. Adoptable dogs can be “cat-tested” upon request. You must provide proof of home ownership or permission to have a dog from your landlord. We cannot hold the dog that you want to adopt while you try to meet this requirement. Adopters are encouraged to bring all the human members of their household, and must bring children age 12 and under residing in the house, to meet their new companion. For information on how to redeem a lost and found animal visit http://www.oaklandanimalservices.org/services/lost-and-found/redeeming-your-pet/ Please bring the animal's number with you to assist us in finding them in the shelter."
            )
        )
    }
}